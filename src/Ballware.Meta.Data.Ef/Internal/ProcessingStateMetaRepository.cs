...
class ProcessingStateMetaRepository : TenantableRepository<Public.ProcessingState, Persistables.ProcessingState>, IProcessingStateMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public ProcessingStateMetaRepository(IMapper mapper, IMetaDbContext dbContext,
