...
class MlModelMetaRepository : TenantableRepository<Public.MlModel, Persistables.MlModel>, IMlModelMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public MlModelMetaRepository(IMapper mapper, IMetaDbContext dbContext,
