...
class StatisticMetaRepository : TenantableRepository<Public.Statistic, Persistables.Statistic>, IStatisticMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public StatisticMetaRepository(IMapper mapper, IMetaDbContext dbContext,
