...
class JobMetaRepository : TenantableRepository<Public.Job, Persistables.Job>, IJobMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public JobMetaRepository(IMapper mapper, IMetaDbContext dbContext,
