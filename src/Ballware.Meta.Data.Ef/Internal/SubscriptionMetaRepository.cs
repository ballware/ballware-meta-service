...
class SubscriptionMetaRepository : TenantableRepository<Public.Subscription, Persistables.Subscription>, ISubscriptionMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public SubscriptionMetaRepository(IMapper mapper, IMetaDbContext dbContext,
