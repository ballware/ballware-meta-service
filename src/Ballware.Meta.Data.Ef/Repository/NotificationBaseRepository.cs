...
public abstract class NotificationBaseRepository : TenantableRepository<Public.Notification, Persistables.Notification>, INotificationMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public NotificationBaseRepository(IMapper mapper, IMetaDbContext dbContext,
