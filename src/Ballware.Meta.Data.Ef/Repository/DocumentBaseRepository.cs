...
public abstract class DocumentBaseRepository : TenantableRepository<Public.Document, Persistables.Document>, IDocumentMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public DocumentBaseRepository(IMapper mapper, IMetaDbContext dbContext,
