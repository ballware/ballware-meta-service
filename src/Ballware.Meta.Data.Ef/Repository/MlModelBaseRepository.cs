...
public abstract class MlModelBaseRepository : TenantableRepository<Public.MlModel, Persistables.MlModel>, IMlModelMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public MlModelBaseRepository(IMapper mapper, IMetaDbContext dbContext,
