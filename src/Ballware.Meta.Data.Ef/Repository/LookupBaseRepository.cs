...
public abstract class LookupBaseRepository : TenantableBaseRepository<Public.Lookup, Persistables.Lookup>, ILookupMetaRepository
{
    private IMetaDbContext MetaContext { get; }

    public LookupBaseRepository(IMapper mapper, IMetaDbContext dbContext,
