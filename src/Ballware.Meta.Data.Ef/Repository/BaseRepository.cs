...
public class BaseRepository<TEditable, TPersistable> : IRepository<TEditable> where TEditable : class, IEditable, new() where TPersistable : class, IEntity, new()
{
    protected IMapper Mapper { get; }
    protected IMetaDbContext Context { get; }
    protected IRepositoryHook<TEditable, TPersistable> ? Hook { get; }

    protected BaseRepository(IMapper mapper, IMetaDbContext dbContext, IRepositoryHook<TEditable, TPersistable>? hook)
    {
        Mapper = mapper;
        Context = dbContext;
        Hook = hook;
