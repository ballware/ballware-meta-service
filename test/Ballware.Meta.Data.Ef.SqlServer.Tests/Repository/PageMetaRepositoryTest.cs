...
public class PageMetaRepositoryTest : RepositoryBaseTest
{
    ...
    public async Task Save_and_remove_value_succeeds()
    {
        ...
        var repository = scope.ServiceProvider.GetRequiredService<IPageMetaRepository>();
        ...
        expectedValue.Lookups = "[]";
        expectedValue.Picklists = "[]";
        ...
        var actualByIdentifier = await repository.ByIdentifierAsync(TenantId, expectedValue.Identifier);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(actualValue?.Lookups, Is.EqualTo(expectedValue.Lookups));
            Assert.That(actualValue?.Picklists, Is.EqualTo(expectedValue.Picklists));
            ...
            Assert.That(actualByIdentifier?.Lookups, Is.EqualTo(expectedValue.Lookups));
            Assert.That(actualByIdentifier?.Picklists, Is.EqualTo(expectedValue.Picklists));
    ...
    public async Task Export_values_succeeds()
    {
        ...
        var exportItemList = new List<Page>();
