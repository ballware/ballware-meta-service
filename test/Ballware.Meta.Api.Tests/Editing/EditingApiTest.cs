...
public class EditingApiTest : ApiMappingBaseTest
{
    ...
    public async Task HandleRemove_succeeds()
    {
        ...
        // Act
        var response = await Client.DeleteAsync($"fakeentity/remove?id={expectedEntry.Id}");
    ...
    public async Task HandleRemove_tenant_not_found()
    {
        ...
        // Act
        var tenantNotFoundResponse = await Client.DeleteAsync($"fakeentity/remove?id={expectedEntry.Id}");
    ...
    public async Task HandleRemove_not_authorized()
    {
        ...
        // Act
        var unauthorizedResponse = await Client.DeleteAsync($"fakeentity/remove?id={expectedEntry.Id}");
    ...
    public async Task HandleRemove_preliminary_check_declined()
    {
        ...
        // Act
        var badRequestResponse = await Client.DeleteAsync($"fakeentity/remove?id={expectedEntry.Id}");
